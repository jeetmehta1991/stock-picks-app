...
### Classification anomalies (tier vs engine mismatch): **20**

| ID | Tier | Engine | Note |
|---|---|---|---|
| `DEC-062` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
| `DEC-138` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
| `DEC-216` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
| `DEC-234` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
| `DEC-378` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
| `DEC-417` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
...
| `DEC-427` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
...
| `DEC-430` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
| `DEC-433` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
| `DEC-436` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
| `DEC-463` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
| `DEC-467` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
| `BUG-027` | DEFERRED | YES | DEFERRED but helper executes in current-phase backtest - intentional pre-wire or misclassification? |
...
- `smoke`: **314** items lack a reference in this tier's test files
- `integration`: **0** items lack a reference in this tier's test files
- `system`: **322** items lack a reference in this tier's test files
- `functional`: **322** items lack a reference in this tier's test files
- `regression`: **324** items lack a reference in this tier's test files
- `data_integrity`: **324** items lack a reference in this tier's test files
- `performance`: **327** items lack a reference in this tier's test files
- `acceptance`: **322** items lack a reference in this tier's test files
- `property`: **327** items lack a reference in this tier's test files
- `snapshot`: **325** items lack a reference in this tier's test files
- `contract`: **314** items lack a reference in this tier's test files
- `compatibility`: **327** items lack a reference in this tier's test files
...
| `DEC-138` | YES | YES | no | YES | no | no | no | no | no | no | no | no | no | no |
...
| `DEC-216` | YES | YES | no | YES | no | no | no | no | no | no | no | no | no | no |
...
| `DEC-378` | YES | YES | no | YES | no | no | no | no | no | no | no | no | no | no |
...
| `DEC-417` | YES | YES | no | YES | no | no | no | no | no | no | no | no | no | no |
...
| `DEC-427` | YES | YES | no | YES | no | no | no | no | no | no | no | no | no | no |
| `DEC-428` | YES | YES | no | YES | no | no | no | no | no | no | no | no | no | no |
| `DEC-429` | YES | YES | no | YES | no | no | no | no | no | no | no | no | no | no |
| `DEC-430` | YES | YES | no | YES | no | no | no | no | no | no | no | no | no | no |
...
| `DEC-436` | YES | YES | no | YES | no | no | no | no | no | no | no | no | no | no |
...
| `DEC-467` | YES | YES | no | YES | no | no | no | no | no | no | no | no | no | no |
...
| `BUG-027` | YES | YES | no | YES | no | no | no | no | no | no | no | no | no | no |
