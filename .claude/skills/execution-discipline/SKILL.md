...
| Describe your own work's coverage as partial, limited, or the easy part | MEASURE IT ANYWAY. #230 EXT applies regardless of DIRECTION: a self-deprecating number feels like candour, and candour does not trigger the scepticism self-praise does, so the bias check never fires. Understating coverage invites the reader to fund work already done | L745 / #230 EXT (called a corpus extension substantial; opening the file showed 43 of 44 gates already covered and ZERO of the named ones lacking a case) |
