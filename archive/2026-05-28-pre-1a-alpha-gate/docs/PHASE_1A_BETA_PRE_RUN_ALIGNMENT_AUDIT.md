...
| `strategy_active` | 220 | code/trade-log |
| `exit_method_total` | 26 | code/trade-log |
| `cube_cells_active` | 5720 | code/trade-log |
| `strategy_exit_override_count` | 16 | code/trade-log |
...
| `tests_collected` | 4250 | code/trade-log |
