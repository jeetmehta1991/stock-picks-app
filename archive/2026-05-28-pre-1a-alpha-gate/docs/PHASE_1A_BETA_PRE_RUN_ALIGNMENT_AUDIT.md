...
|---|---|---|
| `strategy_total` | 223 | code/trade-log |
| `deprecated_count` | 0 | code/trade-log |
| `missing_producer_count` | 0 | code/trade-log |
| `missing_producer_list` | [] | code/trade-log |
| `strategy_active` | 223 | code/trade-log |
| `exit_method_total` | 24 | code/trade-log |
| `cube_cells_active` | 5352 | code/trade-log |
...
| `tests_collected` | 6205 | code/trade-log |
...
| 56 | `strategy_count` | 60 | 223 | `1. No single source of truth per quantitative fact — every doc independently states "6 agents", "60 strategies", etc.` |
...
| 177 | `strategy_count` | 60 | 223 | `**Acceptable phrasing variants (B1035 2026-06-27 updated per Council 129 Option-6 owner-approved naked_poc + m_and_a re-` |
| 177 | `strategy_count` | 72 | 223 | `**Acceptable phrasing variants (B1035 2026-06-27 updated per Council 129 Option-6 owner-approved naked_poc + m_and_a re-` |
...
| Line | Key | Stated | Live | Snippet |
|---:|---|---:|---:|---|
| 82 | `strategy_count` | 60 | 223 | `**Phase 1A (Complete):** We ran all 60 strategies on a small universe of 67 instruments to make sure the pipeline works ` |
| 90 | `strategy_count` | 60 | 223 | `#### What the 60 Strategies Are` |
| 519 | `strategy_count` | 60 | 223 | `Every one of the 60 strategies in Phase 1B evaluates a single stock in isolation. The only market-level input currently ` |
| 531 | `strategy_count` | 60 | 223 | `**What's missing today:** All 60 strategies apply identically regardless of whether a stock's sector ETF is in an uptren` |
| 663 | `strategy_count` | 60 | 223 | `**Why this matters:** Every one of the current 60 strategies can fire during any regime. None of them explicitly time re` |
| 984 | `strategy_count` | 60 | 223 | `3. PROJECT_PLAN strategy count corrected from "60 strategies" to actual count (BUG-66) — auto-generated from `ALL_STRATE` |
...
| 1474 | `strategy_count` | 60 | 223 | `Determine which of 60 strategies, across which market regimes, using which exit method, produce statistically valid trad` |
| 1522 | `strategy_count` | 60 | 223 | `\| 9 \| Minimum trades \| ≥ 500 \| Statistical validity across 60 strategies \|` |
| 1599 | `strategy_count` | 60 | 223 | `## 5. Strategy Universe — 60 Strategies, 7 Categories` |
| 1611 | `strategy_count` | 60 | 223 | `**Short strategy gap:** Only 5 of 60 strategies are short. In bull markets these rarely fire. Phase 1B will validate whi` |
| 1623 | `exit_method_count` | 12 | 24 | `**12 exit methods tested simultaneously** via composite score (40% ROI + 30% profit factor + 30% lowest drawdown):` |
...
| 1977 | `strategy_count` | 60 | 223 | `\| `backtest_results.csv` \| All 60 strategies ranked by all 10 metrics with confidence intervals \|` |
| 2019 | `strategy_count` | 60 | 223 | `## 18. All 60 Strategies — Plain English` |
