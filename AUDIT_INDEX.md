...
| **DECISION-426** | DEC-422 Phase 2: Per-cell statistical engine. For each populated cell: compute n_trades, mean Sharpe, Sortino, win rate, profit factor + Bonferroni-corrected p, PSR, t-stat. Apply 4-gate validity filter (n≥30 + p<0.05 + PSR≥0.95 + t-stat≥3.4). Tag confidence: VALID / MARGINAL / INSUFFICIENT_SAMPLE / INSUFFICIENT_CONFIDENCE. ~3-4 days. Joint with DEC-080/110 already approved. | PENDING | Batch X58 — Phase 1B-α Dimensional Framework (Pass 52) | Pass 52 | - |
