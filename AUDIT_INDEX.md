...
| **DECISION-363** | Expand commodity ETF coverage — owner-approved Pass 52. Add USO (crude oil), UNG (natural gas), DBC (broad commodity basket), DBA (agricultural), CPER (copper), DBB (base metals: copper/aluminum/zinc/lead/nickel), LIT (lithium + battery tech), COPX (copper miners equity). No leveraged variants per existing rule. | PENDING | Batch X1 — Data + Universe | Pass 52 | - |
| **DECISION-364** | Activate Tier 2 + Tier 3 universes for Phase 1B backtesting (not just Stage 3+) — owner-approved Pass 52. Tier 2 (spinoffs/IPOs) + Tier 3 (momentum watchlist, expanded to 100 per owner Pass 52) currently scaffolded but empty CSVs. Phased: Tier 2 first via DEC-105 (spinoff detector), Tier 3 second (requires per-month historical recomputation for backtest validity). | PENDING | Batch X1 — Data + Universe | Pass 52 | - |
| **DECISION-365** | Universe expansion beyond S&P 500 — owner-approved Pass 52. Add Russell 1000 minus S&P 500 ≈ 500 mid-cap names. Phased: Phase A (free, current Russell 1000 static CSV), Phase B (paid, FTSE historical PIT membership), Phase C (Russell 2000 small-cap +1000 tickers, defer pending prefetch cost approval). Total designed universe at full activation: ~1100-1200 instruments. | PENDING | Batch X1 — Data + Universe | Pass 52 | - |
| **DECISION-366** | Liquidity floor for universe inclusion (any tier) — owner-approved Pass 52. Min price $5, min ADV $5M USD, min market cap $300M, min trading days ≥250 in past year. Re-evaluate annually. Replaces the current `min_market_cap_m=100` (BUG-041 flagged as "too low" + BUG-238 fail-open). | PENDING | Batch X1 — Data + Universe | Pass 52 | - |
