...
| **DECISION-354** | Chart pattern strategies — MERGED INTO DEC-099 Pass 52 — chart patterns (cup&handle, H&S, double-top/bottom, wedge, triangle, pennant, flag) are part of the 11 missing strategy categories already framed in DEC-099 (Pass 39 Section 9.1); duplicate logging caught Pass 52 owner correction | SUPERSEDED | Batch X55 — Strategy Coverage Gaps (Pass 52) | Pass 52 | 52 |
