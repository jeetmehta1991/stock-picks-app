...
> **B1029 FRESHNESS NOTE (2026-06-27 doc-sync per owner directive):** **CRITICAL POLICY DRIFT — B982/B983 promoted BH-FDR to HARD GATE + added PSR companion gate (Council 85/86 owner-approved 2026-06-21).** Decision-1 outcome row below ("BH-FDR sanity check") is SUPERSEDED. Critical finding surfaced: Bonferroni was NEVER WIRED in B667 implementation; actual COMPOSE policy was deflated-Sharpe + SPA + BH-FDR sanity-check. B982 promoted BH-FDR to hard gate per Benjamini-Hochberg 1995 + Storey 2003 canonical FDR-control at N>1000. B983 added PSR ≥0.95 companion gate. **LIVE COUNTS (B1010 2026-06-27):** 220 registered / 217 active / 12 EXPLORATORY / 3 DISABLED. Cube: 217×26×7 = 39,494 cells. Family-size N for BH-FDR: 205 deployable (excludes 12 EXPLORATORY via `cube_eligible_for_multiple_testing`). R5 LAUNCHED 2026-06-27 B1028 on AWS i-0940a53c75d049381 (Master 1929 ops × 4y window 2022-05-05 → 2026-05-05).
>
> **B897 ANCHOR (2026-06-18 B895-DEFER-A):** B667-era counts at lines 48 / 54 / 94 / 95 / 97 / 136 ("222 registered / 221 active") preserved for lineage. B722 -3 + B874 -2 + B1010 +1 brought to 220 / 217 active.
