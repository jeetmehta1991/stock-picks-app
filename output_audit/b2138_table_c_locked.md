...
|---|---|---|---|---|---|---|---|---|---|---|
| `cfg1` | 300 | 181 | 0 | 119 | 60 | 18 | P1=20(fixed) P2=2 P3=6 P4=5 P5=5 P6=200(fixed) | 0.51 | 0.129 | cm=True brk=none age=none tail=20 / breakeven_plus_trail |
| `cfg2` | 300 | 97 | 0 | 198 | 93 | 18 | P1=10(fixed) P2=2 P3=6 P4=5 P5=5 P6=50(fixed) | 0.617 | 0.094 | cm=False brk=none age=180 tail=2 / hybrid_50pct_target |
| `w1_span21` | 300 | 176 | 0 | 124 | 60 | 18 | P1=20(fixed) P2=2 P3=6 P4=5 P5=5 P6=21(fixed) | 0.764 | -0.14 | cm=False brk=none age=none tail=20 / r_multiple_2r |
| `w1_span50` | 300 | 179 | 0 | 121 | 59 | 18 | P1=20(fixed) P2=2 P3=6 P4=5 P5=5 P6=50(fixed) | 1.307 | 0.259 | cm=False brk=none age=none tail=5 / r_multiple_2r |
