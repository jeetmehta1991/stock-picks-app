...
**Across the entire ledger (137 entries), 1159 named checks have run and 9 have ever returned non-PASS.**

## Landings - what the supervisor recorded (B2520)

32 cube(s) landed through the supervisor; **1 not yet reported to the owner** (output_candle_tws_c09_b0.3_s0.1_wNone).

| cube | landed | via | battery exit | blocking | WARN/FAIL findings | committed | pushed | reported |
|---|---|---|---|---|---|---|---|---|
| output_candle_tws_c09_b0.3_s0.1_wNone | 2026-09-22T09:36:42 | engine-hook | 0 | none | 0 | 368313132 | True | **NO** |
...
_630 ranked outcomes across 63 graded configs; 604 distinct signatures._
...
## Index - 63 graded config(s), newest first
