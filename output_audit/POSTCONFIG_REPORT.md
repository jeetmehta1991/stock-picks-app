...
**Across the entire ledger (120 entries), 790 named checks have run and 4 have ever returned non-PASS.**

## Landings - what the supervisor recorded (B2520)

15 cube(s) landed through the supervisor; **1 not yet reported to the owner** (output_icg_lookback8_lookback8).

| cube | landed | via | battery exit | blocking | WARN/FAIL findings | committed | pushed | reported |
|---|---|---|---|---|---|---|---|---|
| output_icg_lookback8_lookback8 | 2026-09-04T02:57:37 | engine-hook | 0 | none | 0 | e6ee52ce0 | True | **NO** |
...
_460 ranked outcomes across 46 graded configs; 437 distinct signatures._
...
## Index - 46 graded config(s), newest first
