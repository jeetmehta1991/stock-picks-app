...
**Across the entire ledger (123 entries), 847 named checks have run and 4 have ever returned non-PASS.**

## Landings - what the supervisor recorded (B2520)

18 cube(s) landed through the supervisor; **1 not yet reported to the owner** (output_icg_minq2_minq2).

| cube | landed | via | battery exit | blocking | WARN/FAIL findings | committed | pushed | reported |
|---|---|---|---|---|---|---|---|---|
| output_icg_minq2_minq2 | 2026-09-04T10:54:23 | engine-hook | 0 | none | 0 | f9f2331c9 | True | **NO** |
...
_490 ranked outcomes across 49 graded configs; 467 distinct signatures._
...
## Index - 49 graded config(s), newest first
