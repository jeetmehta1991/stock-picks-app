...
**Across the entire ledger (141 entries), 1235 named checks have run and 9 have ever returned non-PASS.**

## Landings - what the supervisor recorded (B2520)

36 cube(s) landed through the supervisor; **1 not yet reported to the owner** (output_candle_tws_c13_b0.5_s0.0_wNone).

| cube | landed | via | battery exit | blocking | WARN/FAIL findings | committed | pushed | reported |
|---|---|---|---|---|---|---|---|---|
| output_candle_tws_c13_b0.5_s0.0_wNone | 2026-09-22T17:02:48 | engine-hook | 0 | none | 0 | 962a06ffc | True | **NO** |
...
_670 ranked outcomes across 67 graded configs; 644 distinct signatures._
...
## Index - 67 graded config(s), newest first
