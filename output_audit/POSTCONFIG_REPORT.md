...
38 cube(s) landed through the supervisor; **1 not yet reported to the owner** (output_candle_tws_c15_b0.5_s0.1_wNone).

| cube | landed | via | battery exit | blocking | WARN/FAIL findings | committed | pushed | reported |
|---|---|---|---|---|---|---|---|---|
| output_candle_tws_c15_b0.5_s0.1_wNone | 2026-09-23T01:44:31 | engine-hook | 0 | none | 0 | a1611e516 | True | **NO** |
...
| `candle_tws_c15_b0.5_s0.1_wNone` | 1 combination (24 exits ranked) | 0 | 0 | 24 | 1 | - | P1=True(not swept); P2=?; P3=?; P4=?; P5=?; P6=41.97,46.31,50.16,54.42(free, declared) | -0.537 | 0.682 | 0.018 | P2_n_bars=3 P3_min_body_pct=0.500 P4_min_step_pct=0.100 P5_max_wick_pct=none / regime_flip | 2024-05-06..2025-05-02 |
...
| `candle_tws_c15_b0.5_s0.1_wNone` | True(not swept) | ? | ? | ? | ? | 41.97,46.31,50.16,54.42(free, declared) |
