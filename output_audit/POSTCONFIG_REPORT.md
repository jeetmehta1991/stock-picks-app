...
**Across the entire ledger (136 entries), 1140 named checks have run and 9 have ever returned non-PASS.**

## Landings - what the supervisor recorded (B2520)

31 cube(s) landed through the supervisor; **1 not yet reported to the owner** (output_candle_tws_c08_b0.3_s0.0_w0.3).

| cube | landed | via | battery exit | blocking | WARN/FAIL findings | committed | pushed | reported |
|---|---|---|---|---|---|---|---|---|
| output_candle_tws_c08_b0.3_s0.0_w0.3 | 2026-09-22T07:36:50 | engine-hook | 0 | none | 0 | 6b670b336 | True | **NO** |
...
_620 ranked outcomes across 62 graded configs; 594 distinct signatures._
...
## Index - 62 graded config(s), newest first
