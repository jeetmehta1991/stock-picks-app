...
**Across the entire ledger (130 entries), 1008 named checks have run and 9 have ever returned non-PASS.**

## Landings - what the supervisor recorded (B2520)

25 cube(s) landed through the supervisor; **1 not yet reported to the owner** (output_candle_tws_c02_b0.0_s0.0_w0.3).

| cube | landed | via | battery exit | blocking | WARN/FAIL findings | committed | pushed | reported |
|---|---|---|---|---|---|---|---|---|
| output_candle_tws_c02_b0.0_s0.0_w0.3 | 2026-09-21T20:12:49 | engine-hook | 0 | none | 0 | 8e63b8aa7 | True | **NO** |
...
_560 ranked outcomes across 56 graded configs; 534 distinct signatures._
...
## Index - 56 graded config(s), newest first
