...
**Across the entire ledger (131 entries), 1045 named checks have run and 9 have ever returned non-PASS.**

## Landings - what the supervisor recorded (B2520)

26 cube(s) landed through the supervisor; **1 not yet reported to the owner** (output_candle_tws_c03_b0.0_s0.1_wNone).

| cube | landed | via | battery exit | blocking | WARN/FAIL findings | committed | pushed | reported |
|---|---|---|---|---|---|---|---|---|
| output_candle_tws_c03_b0.0_s0.1_wNone | 2026-09-21T21:55:02 | engine-hook | 0 | none | 0 | 0777e95c3 | True | **NO** |
...
_570 ranked outcomes across 57 graded configs; 544 distinct signatures._
...
## Index - 57 graded config(s), newest first
