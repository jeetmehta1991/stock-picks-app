...
**Across the entire ledger (144 entries), 1292 named checks have run and 9 have ever returned non-PASS.**

## Landings - what the supervisor recorded (B2520)

39 cube(s) landed through the supervisor; **1 not yet reported to the owner** (output_candle_tws_c16_b0.5_s0.1_w0.3).

| cube | landed | via | battery exit | blocking | WARN/FAIL findings | committed | pushed | reported |
|---|---|---|---|---|---|---|---|---|
| output_candle_tws_c16_b0.5_s0.1_w0.3 | 2026-09-23T05:12:39 | engine-hook | 0 | none | 0 | a53a1aca5 | True | **NO** |
...
_700 ranked outcomes across 70 graded configs; 674 distinct signatures._
...
## Index - 70 graded config(s), newest first
