# POST-CONFIG BATTERY REPORT - output_b2016_e1_sw30

Source: output_audit/postconfig_ledger.json + output_audit/output_b2016_e1_sw30_grid_auto.json (written by scripts/run_postconfig.py); rendered by scripts/postconfig_report.py; per CHECKLIST #77.

| step | class | status | evidence (truncated) |
|---|---|---|---|
| 1_cube_sanity | AUTO | **DONE** | B2019: 1 strategy, exits/entry [26], 83 entries, cfg stamp 30/200 verified in-cube. MSFT+TSLA present; NVDA ABSENT-BY-ZERO-FIRES (same disclosure as s |
| 2_grade_with_config_params | AUTO | **DONE** | B2019: tighten_breaker_block.py --swing-length 30 --min-n 10 -> output_audit/b2018_e1_sw30_grid.json. Union diagnosis loss 0pct (83/83). |
| 3_outlier_discrepancy_sweep | AUTO | **DONE** | B2019: cube entries == grid max fires (83==83). Verdicts of 300: {210 NO_EXIT_SELECTABLE / 30 BELOW_POWER_FLOOR / 60 ZERO_FIRES}. verify_grid_bands ex |
...
| 8_verdict_with_denominators | JUDGMENT | DONE | B2019 verdict: sw30 produced 83 fires on 50 tickers / 1y. 0 of 300 combinations rankable - BY CONSTRUCTION (holdout_n=0 under the ruled window + the g |
