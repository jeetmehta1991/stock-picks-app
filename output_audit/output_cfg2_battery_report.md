# POST-CONFIG BATTERY REPORT - output_cfg2

Source: output_audit/postconfig_ledger.json + output_audit/output_cfg2_grid_auto.json (written by scripts/run_postconfig.py); rendered by scripts/postconfig_report.py; per CHECKLIST #77.
