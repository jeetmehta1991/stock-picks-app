# POST-CONFIG BATTERY REPORT - output_b2016_e1_sw10

Source: output_audit/postconfig_ledger.json + output_audit/output_b2016_e1_sw10_grid_auto.json (written by scripts/run_postconfig.py); rendered by scripts/postconfig_report.py; per CHECKLIST #77.

| step | class | status | evidence (truncated) |
|---|---|---|---|
| 1_cube_sanity | AUTO | **DONE** | B2018: 1 strategy, exits/entry [26], 172 entries, run at frozen_sha b94d377fa (B2016). Mega-caps NVDA+MSFT+TSLA present. |
| 2_grade_with_config_params | AUTO | **DONE** | B2018: tighten_breaker_block.py --swing-length 10 --min-n 10 -> output_audit/b2018_e1_sw10_grid.json. Union diagnosis loss 0pct (172/172). REQUIRED A  |
| 3_outlier_discrepancy_sweep | AUTO | **DONE** | B2018: cube entries == grid max fires (172==172). Verdicts of 300 rows: {166 NO_EXIT_SELECTABLE / 79 BELOW_POWER_FLOOR / 55 ZERO_FIRES} - ZERO combina |
...
| 8_verdict_with_denominators | JUDGMENT | DONE | B2018 verdict: sw10 produced 172 fires on 50 tickers / 1y (precheck floor 10: passed at 49 baseline fires / 21 tickers). Within-arm tightening NOT GRA |
