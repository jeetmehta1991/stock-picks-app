...
**MEASURED at B2808:** 223 registered, 14 admitted, 60 in-campaign, 149 not-started. Of the
**209 not admitted** - TIGHTEN 14, BOTH 34, LOOSEN 129, NONE 32. So **48 are tightenable
today** and **129 need the engine**, which is the real shape of the backlog.
...
**Three caveats bound every number in it, and are printed in the file itself:**
...
threshold reached through a helper or compared to a config constant is invisible to it); and
`survives_pct` shows `-` for UNMEASURED, never 100pct - it is populated only for strategies
whose current entry condition has been READ and registered in the builder.
