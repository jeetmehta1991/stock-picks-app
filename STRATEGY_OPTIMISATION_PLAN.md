...
**MEASURED at B2811 (supersedes the B2808 figures, which carried two defects - a 5-year span
constant against a 4-year window, S6-B2810b, and a mention-test IN-CAMPAIGN, S6-B2810c):**
223 registered, 14 admitted, 57 in-campaign, 152 not-started. Of the **209 not admitted** -
TIGHTEN 17, BOTH 31, LOOSEN 121, NONE 40. So **48 are tightenable today** (unchanged net:
3 rows moved BOTH->TIGHTEN) and **121 need the engine** (8 moved LOOSEN->NONE as their
corrected projections cleared the grid floor).
