...
| R6 | Three-leg spot check (precompute / production consumer / engine record, n=50 seed 42) | `--help` | usage text | `spot_check_trades.py` (smc), `spot_check_institutional.py` (institutional), **`spot_check_candle.py` (candle pair, B2899 - leg A re-derives the anatomy from raw bars and never imports the producer, which is what makes the agreement evidence rather than a tautology)** |
...
TABLE per campaign.** Columns = the FULL Table A inventory (every P<n> and
B<n> row of SPECS/SPECS_PHASE0), tested axes carrying their thresholds,
untested axes at production value marked resim-only/UNTESTED-OFFLINE; a
late-landing axis (a re-swept coverage skip, a widened band) RE-RENDERS the
one table - separate addendum tables are barred. Renderer:
scripts/table_d_render.py; pinned by test_b2699. The b2694+b2698 split render
with P1-P3 invisible was the incident (L784).
...
### 11.2b3a THE PER-STRATEGY STATUS VIEW - CONSULT IT BEFORE NAMING ANY WORK (B2808, owner-approved 2026-09-13)

**`STRATEGY_OPTIMISATION_STATUS.md`**, regenerated by
`scripts/build_strategy_status.py`, is the single view that answers *has strategy X been
optimised, and which stream is it in*. **Read it before naming ANY strategy, family or batch
...
| stream | meaning | cost |
|---|---|---|
| `TIGHTEN` | a persisted magnitude can be tightened, so the level is a SUBSET of the recorded fires | ZERO engine hours (SS11.2b) |
| `LOOSEN` | fire-starved at the current condition - the productive direction is a WIDER producer band | ENGINE resim; a looser level admits bars the cube never recorded |
...
| T6 | STEP-2: ONE pre-registered holdout read, on the owner's EXPLICIT word - the one-way door (11.2c). Six LIVE_GATES; control-family comparison on any all-six qualifier (11.2b3 step 8). **OFFLINE-ONLY STEP 2 (owner ruling 2026-09-16, B2836): for an offline-only campaign the read covers the FULL cube (544 tickers x the whole 4y window) and the FULL combination population - NO pruning, since Step-1 pruning exists only to cap engine runtime in Step 2. The statistical price rides with the ruling: the multiplicity block prices the FULL number of combinations read (PSR is no substitute, B2376); admission candidates are stated BEFORE the read; it stays ONE read, after which the holdout is SPENT for these objects (B2136)** | `breadth_step2_read.py` / the family reader, fail-closed --ruling | the Step-2 unified artifact; controls recorded | the owner's Step-2 word, every time |
...
whose tighten leg T4 graded nothing rankable). The strategy's Table A file in
`strategy_optimisation/` (B2836) carries the RESIM sides this workflow prices - the
depth looser-bands, the sub-coverage companions, and the price-denominated keys usable
only as producer-side ratios. Pick order: **shared-producer cluster first**
...
**142 sections.** Generated from the working tree; a row is only as current as the last regeneration (#281).

| section | last amended | batch | commit |
|---|---|---|---|
| &nbsp;&nbsp;11.1 ON-RAMP - what must exist BEFORE the first spec of a new strategy launches | 2026-09-21 | B2926 | `dab1149e2` |
| &nbsp;&nbsp;11.2b2c HUB-1's DEPTH CAMPAIGN IS BLOCKED ON REGISTRATION, AND THE FIRST ATTEMPT GRADED  | 2026-09-21 | - | `000000000` |
| &nbsp;&nbsp;11.0b ACTUATION - A BAND WHOSE PARAMETER DOES NOT EXIST IS NOT A BAND (B2866, owner-dire | 2026-09-19 | B2865 | `ff9021535` |
| &nbsp;&nbsp;11.2t THE TIGHTENING WORKFLOW W-T (B2828, owner-directed 2026-09-16) - the mechanical pr | 2026-09-17 | B2855 | `fcd145890` |
| &nbsp;&nbsp;11.2l THE LOOSENING WORKFLOW W-L (B2828, owner-directed 2026-09-16) - the mechanical pro | 2026-09-16 | B2837 | `a8a3061da` |
| 0a. SUPERSESSION BANNER — B1500-B1510 (2026-08-10) | 2026-09-15 | B2811 | `278977476` |
| 0b. STEP-1 WINDOW — THE THREE CONSTRAINTS CANNOT ALL BE MET (B1817, MEASURED) | 2026-09-15 | B2811 | `278977476` |
| 0. HOLDOUT POLICY — SETTLED BY OWNER (2026-08-09) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;This does NOT conflict with Option C — C is now the operative design | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;Moderating the L351 concern — the owner's distinction is correct | 2026-09-15 | B2811 | `278977476` |
| 1. GOVERNING CONSTRAINTS (bind both phases) | 2026-09-15 | B2811 | `278977476` |
| 2. PHASE 1 — TIGHTENING (offline for SUBSET-SAFE params only — see §2.3a) | 2026-09-15 | B2828 | `db3c19610` |
| &nbsp;&nbsp;2.1 Why tightening is cheap and loosening is not | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;2.2 Population — 41 strategies (n > 300)  🔴 SUPERSEDED, see §0a #2 | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;2.3 Method — six steps | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;2.3a RESIMULATION — the rule is SUBSET-SAFETY, not "tightening"  🔴 CORRECTED B1508 | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;2.4 Error checks (each one closes a defect this session actually produced) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;2.5 Standards | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;2.6 Expected outcome, stated honestly | 2026-09-15 | B2811 | `278977476` |
| 3. PHASE 2 — LOOSENING (requires engine runs) | 2026-09-15 | B2828 | `db3c19610` |
| &nbsp;&nbsp;3.1 Population — 108 strategies | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;3.2 The structural choice | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;3.3 Pre-spend requirements (B1335 Rule 1, and the S6-B1465c precedent) | 2026-09-15 | B2811 | `278977476` |
| 4. KILL CRITERIA | 2026-09-15 | B2811 | `278977476` |
| 5. OWNER DECISIONS REQUIRED BEFORE ANY WORK  (superseded by §8 — live list) | 2026-09-15 | B2811 | `278977476` |
| 6. LOCKED REPORTING STANDARD — CHECKLIST #183 (owner-locked B1510) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;6.1 Section 1 — BOOLEAN FORMULA (REQUIRED; a SPEC without it is rejected) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;6.2 Section 2 — TABLE A, parameter inventory | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;6.3 Section 3 — TABLE B, combination results | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;6.4 Section 4 — TABLE C, the post-config funnel | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;6.4b Section 4b — TABLE D, the cross-config ranked list (shipped S6-B2330; documented S6 | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;6.5 The exit registry, and why a cube's exit COUNT is a dated fact | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;6.6 Computed, never hand-written | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;6.7 Drift guard | 2026-09-15 | B2811 | `278977476` |
| 7. WORKED EXAMPLE — `smc_breaker_block_long` (B1500-B1510) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;7.1 What was found | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;7.2 Result | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;7.3 Cost model, measured | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;7.4 Universe finding | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;7.5 What this example changes about the method | 2026-09-15 | B2811 | `278977476` |
| 8. OPEN OWNER DECISIONS (live as of B1510) | 2026-09-15 | B2811 | `278977476` |
| 9. PER-STRATEGY EXECUTION CHECKLIST (B1520, owner-directed) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;9.1 BEFORE any measurement | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;9.2 DERIVING the bands | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;9.3 BEFORE any run | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;9.4 REPORTING the result | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;9.5 Standing rules that bind every step | 2026-09-15 | B2811 | `278977476` |
| 10. THE REPEATABLE WORKFLOW (B1548 — supersedes §2's method for all strategies) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;10.1 The four phases | 2026-09-15 | B2811 | `278977476` |
| STEP 2 ENTRY - THE MECHANICAL TOP-3 CONFIG SELECTION (owner ruling 2026-08-29) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;STEP 2 EXECUTION - THE WATERFALL (owner ruling 2026-08-29, third set) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;DECISIONS RULED - ALL SIX (owner, 2026-08-29, S6-B2375) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;DECISIONS RULED 2026-08-30 (S6-B2409 / S6-B2410) - the floor retired; the qualifier reta | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;STEP 2 PRE-TRIAGE - EXECUTED, AND THE METHOD CHANGED (S6-B2369) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;10.2 Cost model — measured, not assumed | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;10.3 Engine settings for optimisation runs | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;10.4 Monitor arming — MANDATORY, MECHANICALLY ENFORCED | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;10.5 Completion is an ARTIFACT, never a percentage | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;10.6 Interpreting results | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;10.7 Standing owner rulings | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;10.8 Per-strategy checklist | 2026-09-15 | B2811 | `278977476` |
| STEP 0 — Build the SPECS entry (no run; ~1 hour of reading) | 2026-09-15 | B2811 | `278977476` |
| STEP 1 — SEARCH: all fire-adding configs (RULED SHAPE per 10.1: 200 tickers x 1 year 202 | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;1.0 PRE-LAUNCH GATE - run BEFORE building anything | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;1.1 Build the input files | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;1.2 ARM THE MONITOR — **BEFORE** the launch, in the SAME turn | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;1.3 Launch one config | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;1.4 Concurrency | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;1.5 Completion is an ARTIFACT, never a percentage | 2026-09-15 | B2811 | `278977476` |
| STEP 2 — GRADE: derive the subset-safe combinations | 2026-09-15 | B2811 | `278977476` |
| STEP 3 - VALIDATE: the WATERFALL over the top 3 configs (4 years, ALL 544 tickers) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;STEP 3.1 - THE PRE-LAUNCH GATES, in order, every one of them | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;STEP 3.2 - THE SPEC, and the one field that is easy to get wrong | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;STEP 3.3 - MEASURED RUNTIME, and the memory ceiling that stopped the first attempt | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;STEP 3.4 - MONITORING a Step-2 wave | 2026-09-15 | B2811 | `278977476` |
| POST-CONFIG BATTERY — MANDATORY AFTER EVERY CONFIG, STEP 1 **AND** STEP 2 | 2026-09-15 | B2811 | `278977476` |
| STEP 4 — ADMIT | 2026-09-15 | B2811 | `278977476` |
| REFERENCE — ENGINE CONTROLS (code-verified B1570, 2026-08-14) | 2026-09-15 | B2811 | `278977476` |
| REFERENCE — WHAT GETS SKIPPED, AND WHEN | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;PHASE 1B IS DIFFERENT — pruning is INERT there by design | 2026-09-15 | B2811 | `278977476` |
| REFERENCE — MEASURED COSTS (and why a percentage alone is a lie) | 2026-09-15 | B2811 | `278977476` |
| REFERENCE — PARALLELISM | 2026-09-15 | B2811 | `278977476` |
| SWEEP EXECUTION MODE - OPTION C (owner ruling 2026-08-17) | 2026-09-15 | B2811 | `278977476` |
| RUN-SAFETY ARCHITECTURE (B2142-B2169, 2026-08-24/25) — the launch stack as it actually i | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;Throughput, measured (the numbers that drive venue and cap decisions) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;The cap (owner ruling 2026-08-24: 5 hours) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;Observability (session-agnostic by construction) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;The pre-run gate (CHECKLIST #158/#160/#161 — wired, hardened B2149-B2169) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;Post-config battery (run_postconfig.py — invoked by the ENGINE's landing hook through | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;Correlation / effective-breadth measurement (B2182 — zero engine runs) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;Design principle for NEW producers (B2182, external item 10 adopted) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;SPP median column (B2182, external item 7 adopted) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;Standing open decisions this section feeds (owner) | 2026-09-15 | B2811 | `278977476` |
| MANDATORY POST-CONFIG ANALYSIS (owner directive - run after EVERY config, unprompted) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;1. Cube sanity - BEFORE trusting any number | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;2. Grade - with the CONFIG'S OWN parameters (PER FAMILY - B2569 generalisation) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;3. Outlier + discrepancy sweep - ALL of these, every time | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;4. Spot check 50 random trades - EVERY config | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;5. ADVERSARIAL REVIEW - find bugs and logic errors (owner phrasing, verbatim) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;6. POST-FIX RE-CHECK - if this config-run cycle FIXED anything (CHECKLIST #196) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;6b. CARRYING AN EQUIVALENCE CLASS IS FREE - FOR SUBSET-SAFE PARAMETERS ONLY | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;7. IMPLEMENT IN ENGINE - a winner the engine cannot apply is not a winner | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;8. Report the verdict WITH its denominators | 2026-09-15 | B2811 | `278977476` |
| FAILURE MODES — check these before believing a result | 2026-09-15 | B2811 | `278977476` |
| PROGRAMME STATE 2026-09-07 (B2631) — icg CLOSED, family CLOSED, working order | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;RUN-PRODUCERS-ONCE / FAMILY-CUBE REUSE (B2633, owner directive 2026-09-07) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;CURRENT CAMPAIGN - pead family / pead_long_high_yoy_growth_only (B2633, owner go 2026-09 | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;STEP-1 LANDED OFFLINE - pead_long_high_yoy_growth_only (B2638, council 2026-09-07) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;COMPANION-SIGNAL SCREEN - institutional family (B2657, owner green-light 2026-09-09) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;COMPANION-AXIS CAMPAIGN RESULT - the control REFUTES the institutional reading (B2658) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;13F DEPTH PRECOMPUTE BUILT - forward-usable, with a measured density caveat (B2659) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;ADMISSION DOCTRINE RULED + the icg companion holdout read (B2660, owner 2026-09-10) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;THE FULL INSTITUTIONAL GRID - 299 all-six-gate holdout qualifiers across 17 of 20 (B2662 | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;TOP_DECILE BREADTH STEP-1 LANDED OFFLINE (B2673, owner word 'Proceed' 2026-09-11) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;COMPOSITE VARIANT TEST - the upgrade thesis fails on this data (B2674, owner-ruled) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;GRID-STAGE MULTIPLICITY PRICED + THE GRADABILITY CENSUS (B2676/B2677) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;TOP_DECILE BREADTH STEP-2 READ + CONTROL VERDICTS (B2678, owner word 2026-09-11) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;VWAP-EXTENSION STANDALONE PAIR WIRED + PROXY READ (B2680, owner word 2026-09-11) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;TOP_DECILE RE-RULED TO OPTION C - the breadth stack ADMITTED (B2684, owner word 2026-09- | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;XS_LOW_BETA ADMITTED AT BASELINE (B2685, owner word 2026-09-11) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;PEAD RESIM KNOBS WIRED + EXPLORATORY BUCKET RECONCILED (B2686/B2687, owner word 2026-09- | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;SMC FAMILY CAMPAIGN OPENED - PRE-GATE VERDICT: TWO HUBS + INDEPENDENTS (B2690, owner wor | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;SMC WAVE-1 BAND PROPOSAL - AWAITING OWNER REVIEW (B2691, 11.2c gate) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;SMC HUB-1 STEP-1 LANDED (B2694, owner band word 'Lets proceed with step 1') | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;OPTIMISATION POPULATION BY BUCKET AND FAMILY (B2632, owner directive 2026-09-07) | 2026-09-15 | B2811 | `278977476` |
| CURRENT PROGRAMME — institutional_committed_growth_long STEP 1 (S6-B2481..B2499, 2026-09 | 2026-09-15 | B2811 | `278977476` |
| 11. MECHANICAL PROCEDURE FOR ANY STRATEGY (B2573, 2026-09-02) - the ordered list Opus fo | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;11.0 Standing constraints that bind every step (read once, apply always) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;11.2 THE RUN - STEP 0 to STEP 4, in order, with the artifact each step must leave | 2026-09-15 | B2822 | `98244d6ed` |
| &nbsp;&nbsp;11.2b THE OFFLINE-FREE RUN - Step 1 with zero engine hours (B2638) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;11.2b2 TWO LEGS PER CAMPAIGN - DEPTH AND BREADTH (L780, owner-caught 2026-09-11) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;11.2b2b DEPTH IS PRIORITY 1, AND THE VENUE NEVER NARROWS IT (B2702, owner-ruled 2026-09- | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;11.2b2d LEVERAGE DISCIPLINE + GRID-STAGE MULTIPLICITY - ADOPTED (B2815, owner "Approve a | 2026-09-15 | B2823 | `4e9af1620` |
| &nbsp;&nbsp;11.2b3 BREADTH WORKFLOW STANDARD (B2693, owner-ruled 2026-09-12) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;11.2b3a THE PER-STRATEGY STATUS VIEW - CONSULT IT BEFORE NAMING ANY WORK (B2808, owner-a | 2026-09-15 | B2834 | `6c19c4cf9` |
| &nbsp;&nbsp;11.2b4 THE 38 STRATEGIES WHOSE ENTRY CONDITION MOVED AFTER R5 (B2806, owner-directed 202 | 2026-09-15 | B2813 | `d3c34aa63` |
| &nbsp;&nbsp;11.2w THE DRIVER LOOP - how Opus picks up work, every session (B2829) | 2026-09-15 | B2829 | `0db16e253` |
| &nbsp;&nbsp;11.2s SHARED-PRODUCER RESIM REUSE - the mechanics, and why the full consumer set is FORC | 2026-09-15 | B2828 | `db3c19610` |
| &nbsp;&nbsp;11.2c APPROVAL FLOW - which word covers which stage (L779, owner-mandated 2026-09-10) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;11.3 The turn-close that every step above requires | 2026-09-15 | B2811 | `278977476` |
| APPENDIX S1-200 - THE 200 STEP-1 TICKERS (owner ruling 2026-08-29) | 2026-09-15 | B2811 | `278977476` |
| &nbsp;&nbsp;B2701 - smc hub-1 STEP-2: the one holdout read, CLEAN NEGATIVE (2026-09-12) | 2026-09-15 | B2811 | `278977476` |
