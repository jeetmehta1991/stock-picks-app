...
| P2 | STRATEGY | news_article_count `>= 3` [EXISTING-THRESHOLD] | `>= 3` | measured tighter QUANTS levels - see the free-band section below | looser side - band at R1 | MEASURED-PRE-R1 |
| P3 | STRATEGY | news_sentiment_mean `> 0.3` [EXISTING-THRESHOLD] | `> 0.3` | measured tighter QUANTS levels - see the free-band section below | looser side - band at R1 | MEASURED-PRE-R1 |
