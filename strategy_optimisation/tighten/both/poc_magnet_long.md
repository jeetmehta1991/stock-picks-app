...
| P2.1 | BAND | profile (lookback_days, n_bins) + side rule - backtest/signals/volume_profile.py:46-58 | (60, 40) | none - POC at other params unpersisted | the whole band; DEFINED-NO-ACTUATOR | BRACKET production; T3 review before any grid |
| P3 | STRATEGY | vp_close_near_poc_pct `< 0.03` [EXISTING-THRESHOLD] | `< 0.03` | measured tighter QUANTS levels - see the free-band section below | looser side - band at R1 | MEASURED-PRE-R1 |
