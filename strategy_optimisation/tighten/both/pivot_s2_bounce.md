...
|---|---|---|---|---|
| P1.1 | implicit anatomy knobs (min body/wick/st | 1 | **FIRE-ADDING** | no - production only (DEFINED-NO-ACTUATOR) |
...
| P5.1 | proximity tolerance to S2 (abs dist/leve | 1 | **FIRE-ADDING** | no - production only (DEFINED-NO-ACTUATOR) |
...
```
FULL FACTORIAL     1 x 1 x 1 x 1 x 1 x 5 x 1 x 1 = 5
