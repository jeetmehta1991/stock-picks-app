...
|---|---|---|---|---|
| P1.1 | cluster rule (unique buyers >= N in wind | 1 | **FIRE-ADDING** | no - production only (DEFINED-NO-ACTUATOR) |
| P2.1 | count window (days) | 1 | **FIRE-ADDING** | no - production only (DEFINED-NO-ACTUATOR) |
...
```
FULL FACTORIAL     1 x 1 x 3 x 2 x 2 = 12
