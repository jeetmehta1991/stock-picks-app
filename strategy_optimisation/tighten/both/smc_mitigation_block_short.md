...
| P2.1 | mirror of mitigation_long | 1 | **FIRE-ADDING** | no - production only (DEFINED-NO-ACTUATOR) |
...
```
FULL FACTORIAL     3 x 1 x 5 x 1 = 15
...
B-row candidates NOT in this factorial: 494 census axes join it only when REGISTERED at the T3 band review.
