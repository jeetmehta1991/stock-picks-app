...
**Lane:** BOTH | **family:** candle | **status:** STALLED-CAMPAIGN | **R5 fires:** 2280 | **surviving fires (T1):** 1053 (survives_pct 0.4618)
...
|---|---|---|---|---|
| P2.1 | mid-candle small-body ratio (body < X *  | 3 | **FIRE-ADDING** | no - production only (DEFINED-NO-ACTUATOR) |
| P2.2 | recovery rule (close above midpoint of b | 4 | **FIRE-ADDING** | no - production only (DEFINED-NO-ACTUATOR) |
...
```
FULL FACTORIAL     3 x 4 x 5 x 3 x 1 x 3 x 5 x 1 = 2700
