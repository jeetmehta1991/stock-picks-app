...
**Deployable total: 7 graded cells + 4 funnel mirrors + 1 dual self-mirrors + 3 Step-2 admissions + 2 admission mirrors = 16 distinct strategies** (dual mirrors are already counted in their parent cell), plus 2 mirrors to create.
