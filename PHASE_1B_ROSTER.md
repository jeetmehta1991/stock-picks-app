...
| `xs_momentum_top_decile` | long | **GRID-SELECTED-OWNER-RULED** | campaign=B2667 offline, axes=momentum_12_1/max_decile/ivol_decile; xs_momentum_12_1=0.529, xs_max_anomaly_decile=999.0, xs_ivol_decile=999.0 | `time_stop_10d` |   0.75 |  -0.31 |   2.18 |   0.59 | +1.183 |   1.00 |   3.03 |   3.27 | 0.659 |   3.16 | 41 | 128 | `xs_momentum_bottom_decile_short` |

**PROVISIONAL-UNREVIEWED (1 of 13).** These admissions come from a Step-2 config whose four JUDGMENT post-config steps have NOT been run - they were SKIPPED citing a wave-level review batch that has never existed (S6-B2436 / L721). The five AUTO steps DID run and are DONE. The completeness gate now BLOCKS such a config (S6-B2440). The row stands, marked, until the pilot review clears it; if that review changes the verdict, the admission is revisited.
...
**S6-B2649 (2026-09-10)** - owner verbatim: *"Lets start with queued campaign"* - strategy `xs_momentum_top_decile`, R5 merged cube output_r5_merged_1_7 (544-ticker universe; 255 fires), 4 years 2022-05-05 .. 2026-05-05 (IS 3y + 1y holdout); artifact `output_audit/b2668_topdecile_admission_grid.json`.
