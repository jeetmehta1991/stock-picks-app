...
1. **~17 Wave 3 strategies missing** (was ~30; Batches 330+331+332+333 shipped 13 of ~30): 7 13F-based (Batch 330+331), 3 classification_change (Batch 332 with producer at universe.get_classification_change_signals reading sector_history.csv), 3 persistence-proxy (Batch 333 using Batch-330 producer's institutional_increased / new_positions counts). True multi-quarter persistence precompute queued as Batch 333b. Remaining ~3 13F + ~7 classification_change + ~7 persistence still pending.
