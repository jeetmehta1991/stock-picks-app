...
1. **~13 Wave 3 strategies missing** (was ~30; Batches 330+331+332+333+335 shipped 17 of ~30): 7 13F-based (Batches 330+331), 7 classification_change (Batches 332+335 with producer at universe.get_classification_change_signals + symmetric from_tech flag), 3 persistence-proxy (Batch 333 using Batch-330 producer's institutional_increased / new_positions counts). True multi-quarter persistence precompute queued as Batch 333b. Remaining ~3 13F + ~3 classification_change + ~7 persistence still pending.
