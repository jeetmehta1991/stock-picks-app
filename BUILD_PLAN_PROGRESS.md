...
1. **~9 Wave 3 strategies missing** (was ~30; Batches 330+331+332+333+335+336 shipped 21 of ~30): **10 13F-based COMPLETE** (Batches 330+331+336), 7 classification_change (Batches 332+335), 4 persistence-proxy (Batches 333+336 using Batch-330 producer's institutional counts + insider director/officer keys). True multi-quarter persistence precompute queued as Batch 333b. Remaining ~3 classification_change + ~6 persistence still pending.
