...
1. **~3 Wave 3 strategies missing** (was ~30; Batches 330+331+332+333+335+336+337 shipped 27 of ~30): **10 13F-based COMPLETE** (Batches 330+331+336), **10 classification_change COMPLETE** (Batches 332+335+337), 7 persistence-proxy (Batches 333+336+337 using Batch-330 producer's institutional counts + insider director/officer keys). True multi-quarter persistence precompute queued as Batch 333b. Remaining ~3 persistence still pending - likely best implemented via Batch 333b precompute infrastructure.
