...
1. **~27 Wave 3 strategies missing** (was ~30; Batch 330 2026-05-25 shipped first 3 13F-based: `institutional_cluster_long`, `institutional_buy_momentum_long`, `institutional_distribution_short` with producer-side injection of institutional_signal into per-ticker signals dict). Remaining ~7 13F + ~10 classification_change + ~10 persistence still pending.
