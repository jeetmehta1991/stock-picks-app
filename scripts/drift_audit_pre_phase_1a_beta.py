...
HISTORICAL_NARRATIVE_DOCS = {
    ...
    # AUDIT_TRIAGE.md archived Batch 426
    "ENGINEERING_REGISTER.md", "OPEN_INVESTIGATIONS.md",
    "LEARNINGS.md", "UNIVERSAL_LEARNINGS.md",
    # PASS_53_PRIORITIES.md archived Batch 420; TRIAGE_PREP_2026_05_19.md archived Batch 425
...
FORWARD_LOOKING_DOCS = {
    ...
    # IMPLEMENTATION_DRAFTS_T1.md archived Batch 893 (2026-06-18) per owner approval
    # IMPLEMENTATION_READINESS_DASHBOARD.md archived Batch 429 (self-superseded)
    ...
    # PHASE_1B_AUDIT_2026_05_25.md archived Batch 893 (2026-06-18) per owner approval
    "PHASE_1B_STATE_SCHEMA_DIFF.md",
    # PHASE_1A_PRELAUNCH_TODO archived Batch 420
    # T1A_COMPREHENSIVE_REVIEW_2026_05_20 / COMPREHENSIVE_REVIEW_2026_05_20 /
    # DESIGN_AUDIT_2026_05_20 (+parts 2/3) / SIGNAL_AUDIT_2026_05_21 archived Batch 425
    "README.md", "STRATEGY_REGISTER.md", "STRATEGY_ROSTER_FULL.md",
    "API_ENDPOINT_INVENTORY.md",
    # API_AUDIT.md archived Batch 431
    # BATCH_318_PROCESS_POOL_DESIGN.md archived Batch 428
    "EXPLANATION.md", "OHLCV_INTEGRITY_REPORT.md",
    # POST_MAY_29_OPERATION_GUIDE.md archived Batch 426
    # PREFETCH_COVERAGE_AUDIT.md archived Batch 431
    "STAGE_3_PAPER_TRADING_ACTIVATION.md",
    # THEME_X53_SEQUENCING archived Batch 420
}
