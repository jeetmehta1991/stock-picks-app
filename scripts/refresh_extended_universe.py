...
OUTPUT: Backtesting universe/Tier 2 Universe_Spinoffs and Recent IPOs_Feb 2010 to May 2026.csv (B++ schema: Symbol, Company, Sector, added_date, removed_date, MarketCapB, Tier2Reason)
"""
import argparse
import sys
import time
