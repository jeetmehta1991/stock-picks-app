...
DEFERRED_DECS = {
    ...
    "DECISION-151", "DECISION-155", "DECISION-159", "DECISION-179",
    "DECISION-183", "DECISION-209", "DECISION-211", "DECISION-216",
    "DECISION-230", "DECISION-231", "DECISION-234", "DECISION-235",
    "DECISION-279", "DECISION-280", "DECISION-314", "DECISION-354",
...
# Phase 2 additions: 155 / 179 / 211 / 279 (HELPER_ONLY classifier hits where
# manual verification confirmed: helper exists but no engine call-path
# consumer; not previously caught by Phase 1's "self-confessed-deferred-text"
# filter because these were written without the explicit phrase).
