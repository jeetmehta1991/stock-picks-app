...
**2026-06-27 B1010 LIVE COUNT:** `len(ALL_STRATEGIES) = 220` registered; `DEPRECATED_STRATEGIES = 0`; `STRATEGIES_DISABLED_MISSING_PRODUCER = 3` (dxy_headwind_multinational_short + naked_poc_retest_long B975 + m_and_a_target_long B984); **217 active for Phase 1A-β cube** (217 × 26 × 7 regimes = 39,494 cells). 12 strategies EXPLORATORY-tagged (cube-eligible but excluded from BH-FDR family-N denominator). B1028 R5 launched 2026-06-27 on AWS i-0940a53c75d049381 (Master 1929 ops intersection x 4y window 2022-05-05 to 2026-05-05).

> **HISTORICAL ANCHOR (2026-05-26 Batch 372):** `len(ALL_STRATEGIES) = 186` registered; `STRATEGIES_DISABLED_MISSING_PRODUCER = 1`; 185 active (185 × 25 = 4,625 cells). The "60" figure below refers to the Layer 1 baseline only; the live total spans Layer 1 + Layer 2 + Layer 3 + Wave 3 + Batch 316a un-deprecated.

> **B897 FRESHNESS NOTE (2026-06-18 B895-DEFER-A tranche 1):** Above is Batch 372 historical anchor (2026-05-26). **LIVE COUNTS as of B1010 2026-06-27:** 220 registered / 217 active. Cube: 217 × 26 × 7 = 39,494 cells. B372→B874→B1010 lineage: +35 net additions via B709 EMPIRICAL-RESTORE + B685/B686 + B636/B645 + B603/B605/B607/B610 chart-pattern mirrors + B580/B581 Layer 2D ICT sweeps + B1010 Class 7 NEW (insider_cluster_concentrated_sell_short) − 5 deletions (B620/B682/B687/B722/B874). Inline "186 / 185" references preserved for historical lineage; canonical current state in CLAUDE.md banner + CANONICAL_FACTS.md F-002.
