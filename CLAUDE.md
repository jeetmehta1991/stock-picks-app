...
backtest/
  ...
  signals/
    ...
    screener.py          # 186 strategy classes (live `len(ALL_STRATEGIES)` 2026-05-25; was 148 pre-Batch 316a un-deprecation; Layer 1 baseline 60 + later layers per CANONICAL_FACTS.md F-002). 0 in DEPRECATED_STRATEGIES (Batch 316a empty). Phase 1A-β cube tests 186 × 25 = 4,650 cells.
  engine/
