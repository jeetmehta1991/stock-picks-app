...
backtest/
  ...
  signals/
    ...
    screener.py          # 219 strategy classes registered live `len(ALL_STRATEGIES)` 2026-06-21 (was 198 through Batch 487; +21 net adds across SM/EV/CC/Pattern walks; -5 deletions; B874 -2 + B975 disabled +1). 0 in DEPRECATED_STRATEGIES (Batch 316a empty). 2 in STRATEGIES_DISABLED_MISSING_PRODUCER (Batch 372 `dxy_headwind_multinational_short` — foreign_rev_pct producer absent; B975 2026-06-21 `naked_poc_retest_long` — naked_poc producers never implemented). 217 active for Phase 1A-β cube; Batch 487 SM2 added 26th exit method `smart_money_reversal`; cube cells 217 × 26 = 5,642.
  engine/
