...
- Tier 2 (extended universe — spinoffs >$5B + recent IPOs >$10B): **Sprint 1 historical populate** (post-Polygon-prefetch) via Polygon corporate actions DEC-380; **Sprint 5 ongoing automation** per DEC-372/373/374 (GH Actions monthly refresh) + DEC-380 (Polygon corporate actions live).
- Tier 3 (momentum watchlist): **Sprint 1 historical populate** (post-Polygon-prefetch — strict precondition) via Jegadeesh-Titman 12-1 momentum per DEC-496 RESOLVED-DECIDED (252-day lookback, 21-day skip, risk-adjustment OFF, tie-breakers vol-asc→ADV-desc; top 100 non-T1 by score per DEC-364). **Sprint 5 ongoing automation** per DEC-104/375/376/377. Static for backtesting (computed at run start; not lookahead).
