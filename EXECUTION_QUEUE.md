...
| 5 | `dashboard-batch430-verify` | Verify Tab 10 / 11 / 13 + Tabs 1-9 + Exits + Trades render correctly post-Batch-430 fix | BLOCKED | Owner action: hard-refresh `https://jeetmehta1991.github.io/stock-picks-app/dashboard_phase_1a/` after Pages publishes. Confirm: markdown renders on Tab 10; structured KPIs+table on Tab 11; DataTables show data on 1-9/Exits/Trades/13. |
