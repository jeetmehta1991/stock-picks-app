...
WIRING_MATRIX = [
    ...
    ("Wikipedia pageviews",
     ...
     "backtest/data/sentiment.py",
     "*.parquet"),
    # ── Pass 53 Day-9 v8c Wave A-D additions ────────────────────────────────
    ("ALFRED vintage (Sprint 0A) — G9",
     "data_prefetch/alfred",
     "backtest/data/macro.py",
     "*.parquet"),
    ("FRED VIXCLS (Sprint 0A) — G1",
     "data_prefetch/fred/observations",
     "backtest/data/macro.py",
     "VIXCLS.parquet"),
    ("Polygon events (G6)",
     "data_prefetch/polygon/events",
     "backtest/data/fetcher.py",
     "*.parquet"),
    ("SEC EDGAR 8-K (G7)",
     "data_prefetch/sec_edgar/8_K",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("SEC EDGAR Form 4 (G7)",
     "data_prefetch/sec_edgar/4",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("SEC EDGAR SC 13D (G7)",
     "data_prefetch/sec_edgar/SC_13D",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("SEC EDGAR SC 13G (G7)",
     "data_prefetch/sec_edgar/SC_13G",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("pytrends search (G8)",
     "data_prefetch/pytrends",
     "backtest/data/sentiment.py",
     "*.parquet"),
    ("Quiver insider per-tkr (G10)",
     "data_prefetch/quiver/insider",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("Quiver etfholdings (G12)",
     "data_prefetch/quiver/etfholdings",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("Quiver offexchange (G13)",
     "data_prefetch/quiver/offexchange",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("Quiver topshareholders (G14)",
     "data_prefetch/quiver/topshareholders",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("Quiver wallstreetbets (G15)",
     "data_prefetch/quiver/wallstreetbets",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("Quiver patentmomentum (G17a)",
     "data_prefetch/quiver/patentmomentum",
     "backtest/data/smart_money.py",
     "global.parquet"),
    ("Quiver corporatedonors (G17b)",
     "data_prefetch/quiver/corporatedonors",
     "backtest/data/smart_money.py",
     "global.parquet"),
    ("Quiver sec13f bulk (G17d)",
     "data_prefetch/quiver/sec13f",
     "backtest/data/smart_money.py",
     "global.parquet"),
    # ── Pass 53 Day-9 v8h additions (Tier C/D + new SEC EDGAR forms) ──
    # FRED additions (VIX3M, DXY, TED, WTI, housing, retail, etc. — DEC-513 #7
    # spec gaps + macro signals). Sentinel: VXVCLS for VIX3M, FedFunds 30d.
    ("FRED VIX3M (VXVCLS) Day-9 v8h",
     "data_prefetch/fred/observations",
     "backtest/data/macro.py",
     "VXVCLS.parquet"),
    ("FRED DXY trade-weighted (DTWEXBGS)",
     "data_prefetch/fred/observations",
     "backtest/data/macro.py",
     "DTWEXBGS.parquet"),
    ...
    ("CFTC E-mini SP500 (existing)",
     "data_prefetch/cftc",
     "backtest/data/sentiment.py",
     "cot_emini_sp500.parquet"),
    ("CFTC VIX futures (Tier C3)",
     "data_prefetch/cftc",
     "backtest/data/sentiment.py",
     "cot_vix_futures.parquet"),
    ("CFTC UST 10Y NOTE (INV-011 fix)",
     "data_prefetch/cftc",
     "backtest/data/sentiment.py",
     "cot_treasury_10y.parquet"),
    ("CFTC gold (Tier C3)",
     "data_prefetch/cftc",
     "backtest/data/sentiment.py",
     "cot_gold.parquet"),
    # SEC EDGAR new form types (Tier B1-B4)
    ("SEC EDGAR 10-K (Tier B1)",
     "data_prefetch/sec_edgar/10_K",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("SEC EDGAR 10-Q (Tier B1)",
     "data_prefetch/sec_edgar/10_Q",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("SEC EDGAR DEF 14A (Tier B2)",
     "data_prefetch/sec_edgar/DEF_14A",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("SEC EDGAR S-1 (Tier B3)",
     "data_prefetch/sec_edgar/S_1",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("SEC EDGAR SC 13D/A (Tier B4)",
     "data_prefetch/sec_edgar/SC_13D_A",
     "backtest/data/smart_money.py",
     "*.parquet"),
    ("SEC EDGAR SC 13G/A (Tier B4)",
     "data_prefetch/sec_edgar/SC_13G_A",
     "backtest/data/smart_money.py",
     "*.parquet"),
    # Polygon static / snapshot endpoints (Tier D)
    ("Polygon snapshot gainers (Tier D1)",
     "data_prefetch/polygon/snapshot",
     "backtest/data/fetcher.py",
     "gainers.parquet"),
    ("Polygon market_status (Tier D2)",
     "data_prefetch/polygon/market_status",
     "backtest/data/fetcher.py",
     "now.parquet"),
    ("Polygon reference_meta exchanges (Tier D3)",
     "data_prefetch/polygon/reference_meta",
     "backtest/data/fetcher.py",
     "exchanges.parquet"),
]
