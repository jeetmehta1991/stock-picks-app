...
def test_batch605_all_strategies_count_after_b605():
    ...
    # B622 floor-pin (converted from ==); B899 migration post-B874 (221->219 via B722 -3 + B874 -2).
    assert len(ALL_STRATEGIES) >= 219, (
        f"Expected >= 219 post-B874 (B605 +1 Class 7 NEW; B722 -3; B874 -2); got {len(ALL_STRATEGIES)}"
    )
