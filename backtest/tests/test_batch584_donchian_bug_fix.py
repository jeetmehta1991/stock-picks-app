...
def test_batch584_donchian_breakdown_short_downstream():
    ...
    Batch 591 deleted this strategy; Batch 592 RESTORED; Batch 595 walk
    added 2 symmetry gates (close_below_open + close_in_bottom_40pct).
    B612 LOW-priority refactor: SHORT switched from `NOT macd_bullish`
    to positive macd_12_26_9_bearish. B622 fixture-drift repair: swap
    to positive symmetric signal."""
