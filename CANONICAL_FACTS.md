...
**Live value (`len(ALL_STRATEGIES)` 2026-06-04 Batch 580):** **207 IMPLEMENTED strategy classes registered** in `backtest/signals/screener.py::ALL_STRATEGIES` (was 188 through Batch 467; +10 Batch 487 SM1 smart-money sleeves; +2 Batch 507 M6 Path-2 YoY-growth PEAD sleeves; +2 Batch 519 P15 squeeze/borrow sleeves; +2 Batch 531 P17 activist_13d_long + m_and_a_target_long; +1 Batch 572 doji_at_resistance_short per Stage 4 candle cluster walk; +2 Batch 580 turtle_soup_long + turtle_soup_short Layer 2D ICT first inline-spec patterns per Raschke Street Smarts 1996). `DEPRECATED_STRATEGIES` set is empty (Batch 316a un-deprecation 2026-05-25 reversed Batch 218). `STRATEGIES_DISABLED_MISSING_PRODUCER` set holds **1 strategy** (`dxy_headwind_multinational_short`; Batch 372 2026-05-26 owner-directed disable — foreign_rev_pct producer absent across Polygon Stocks Starter, SEC EDGAR companyfacts, SEC XBRL prefetch, Finnhub financials_reported; semantically distinct from literature-null deprecation). **206 active for next cube iteration** (206 × 26 = 5,356 cells; was 204 × 26 = 5,304 pre-Batch-580; Batch 487 SM2 added 26th exit method `smart_money_reversal`). Re-enable is a single-line removal once a 10-K XBRL segment-axis parser ships or paid Polygon Plus tier is approved.
