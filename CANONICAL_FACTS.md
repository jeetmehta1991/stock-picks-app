...
**Acceptable phrasing variants (B1035 2026-06-27 updated per Council 129 Option-6 owner-approved naked_poc + m_and_a re-enable):** "220 IMPLEMENTED + 13 EXPLORATORY + 1 DISABLED = 219 active (Phase 1A-β cube)" — or scope-narrow: "Layer 1 baseline (60 classes per PROJECT_PLAN §6)". *Not acceptable:* a bare "60 strategies" or "72 strategies" without scope qualifier; the legacy "108-133+ classes" phrasing PRE-DATES Pass 53 Layer 1.I symmetry adds + Layer 2D ICT inline-spec + Class 7 NEW walks (B603/B636/B645/B685/B686 etc.) and should not be used (banner-flagged stale by CLAUDE.md 2026-06-18).
