...
**Value (planned):** **~270-280 active signal fields in Stage 2 backtest, broken into 6 canonical categories. Stage 3+ adds Category 3 options (~5+ fields planned) + completes Category 6 fundamentals. Owner expects "over 200" — confirmed; total exceeds 250 across categories.**
