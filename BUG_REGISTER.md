...
| BUG-102 | CRITICAL  -  3.5x same-day duplicate inflation: 9,921 unique decisions logged as 3 | DEC-458 | (see linked DEC sprint) |
| BUG-103 | CRITICAL  -  Smart money data prefetched for 7 categories x 509 tickers but never  | DEC-458 | (see linked DEC sprint) |
